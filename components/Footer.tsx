            ...
            <div className="row clearfix">
              <div className="col-sm-12">
                <div className="it-brand-wrapper">
                  <a href="#">
                    <svg className="icon">
                      <use xlinkHref="/bootstrap-italia/dist/svg/sprites.svg#it-code-circle"></use>
                    </svg>
                    <div className="it-brand-text">
                      <h2 className="no_toc">Lorem Ipsum</h2>
              ...
              <div className="col-lg-4 col-md-4 pb-2">
                <div className="pb-2">
                  ...
                  <ul className="list-inline text-left social">
                    <li className="list-inline-item">
                      <a className="p-2 text-white" href="#" target="_blank">
                        <svg className="icon icon-sm icon-white align-top">
                          <use xlinkHref="/bootstrap-italia/dist/svg/sprites.svg#it-designers-italia"></use>
                        </svg>
                    ...
                    <li className="list-inline-item">
                      <a className="p-2 text-white" href="#" target="_blank">
                        <svg className="icon icon-sm icon-white align-top">
                          <use xlinkHref="/bootstrap-italia/dist/svg/sprites.svg#it-medium"></use>
                        </svg>
                    ...
                    <li className="list-inline-item">
                      <a className="p-2 text-white" href="#" target="_blank">
                        <svg className="icon icon-sm icon-white align-top">
                          <use xlinkHref="/bootstrap-italia/dist/svg/sprites.svg#it-behance"></use>
                        </svg>
                ...
                <div className="pb-2">
                  ...
                  <form action="#" method="post">
                    <label htmlFor="input-newsletter" className="active">
